;; my custom functions
(defun rm-digits-string (str)
  "Removes digits from a string"
  (replace-regexp-in-string "[0-9]" "" str)
)

(defun underscore-to-space-string (str)
  "Replaces underscore with space from a string"
  (replace-regexp-in-string "_" " " str)
)

(defun rm-leading-chars (chars str)
  (replace-regexp-in-string (concat "^" (concat chars "+")) "" str))

;; titlecase from https://hungyi.net/posts/programmers-way-to-title-case/
(require 'cl-lib)
(require 'subr-x)
